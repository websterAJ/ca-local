...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="<?= _BASE_URL_?>img/logo.png">
    <title></title>
    ...
    <script src="<?= _BASE_URL_?>js/jquery.min.js"></script>
    <script>window.jQuery || document.write('<script src="<?= _BASE_URL_?>js/jquery.min.js"><\/script>')</script>
    <script src="<?= _BASE_URL_?>js/jquery-ui.js"></script>
  </head>
  <body>
